...
import { CRITTER_TYPES, MONTHS, VUEX_MUTATIONS, MODULE } from '../constants';
...
export default {
  ...
  computed: {
    ...
    ...mapGetters({
      getCaughtCritter: 'getCaughtCritter',
    }),
  ...
  watch: {
    critter (newCritter) {
      ...
      this.isCaught = !!this.getCaughtCritter(properties);
    },
  ...
  methods: {
    ...mapMutations([
      VUEX_MUTATIONS.SET_CAUGHT_CRITTER_STATUS,
    ]),
    ...
    onCaughtChange () {
      ...
      this.setCaughtCritterStatus(payload);
    },
