...
import { CRITTER_TYPES, MONTHS, SORT_OPTIONS, VUEX_MUTATIONS, MODULE } from '../constants';
...
export default {
  ...
  methods: {
    ...mapMutations([
      VUEX_MUTATIONS.SET_FILTERS_SEARCH_TERM,
      VUEX_MUTATIONS.SET_FILTERS_LOCATION,
      VUEX_MUTATIONS.SET_FILTERS_MIN_BASE_PRICE,
      VUEX_MUTATIONS.SET_FILTERS_MAX_BASE_PRICE,
      VUEX_MUTATIONS.SET_FILTERS_SORT,
      VUEX_MUTATIONS.SET_FILTERS_CAUGHT,
      VUEX_MUTATIONS.SET_FILTERS_NORTHERN_MONTHS_AVAILABLE,
      VUEX_MUTATIONS.SET_FILTERS_SOUTHERN_MONTHS_AVAILABLE,
    ...
    onCaughtChange () {
      this.setFiltersCaught(this.caught ? this.caught.value : '');
    },
